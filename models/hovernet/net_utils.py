...
class UpSample2x(nn.Module):
    """Upsample input by a factor of 2. Upsample输入乘以2

    Assume input is of NCHW, port FixedUnpooling from TensorPack.
    假设输入是NCHW，端口FixedUnpooling来自TensorPack。
    """
