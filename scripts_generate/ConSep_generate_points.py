...
if __name__ == '__main__':
    ...
    parser.add_argument('-r','--root_dir', type=str, default=r"D:\组会内容\data\HoVer_ConSep\consep_cut_256\Train",
                        help='带掩码级注释的数据根目录的路径')
    parser.add_argument('-p', '--point-ratio', type=float, default=0.01,  # 参数用于控制已标记像素的百分比。default=1e-4
    ...
    # executor = Parallel(n_jobs=os.cpu_count()-2)  # 并行化计算
