...
if __name__ == '__main__':
    ...
    parser.add_argument('-r','--root_dir', type=str, default=r"D:\组会内容\data\PanNuke Dataset\Fold 1\data",
                        help='带掩码级注释的数据根目录的路径')
    parser.add_argument('-p', '--point-ratio', type=float, default=1e-4,  # 参数用于控制已标记像素的百分比。default=1e-4
    ...
    mask_dir = os.path.join(args.root_dir, 'masks','bi_png')
